<!-- filepath: /storage/trustyowl/frontend/src/components/TermsConditions.vue -->
<template>
  <div class="min-h-screen pt-32 bg-[#f8f9fa]">
    <section id="terms" class="max-w-[800px] mx-auto p-16 px-8">
      <div class="container mx-auto px-6">
        ...
        <div class="bg-white p-8 rounded-lg shadow-sm text-[#2c3e50]">
          ...
          <p class="mb-6">
            These Terms and Conditions ("Terms") govern your use of the trustyowl.com website (the "Service") operated by Trusty Owl ("us", "we", or "our"). Please read these Terms carefully before using the Service.
          </p>

          <h2 class="text-xl font-bold mb-4 text-[#2a4f4b]">2. Intellectual Property</h2>
          <p class="mb-6">
            The Service and its original content, features, and functionality are and will remain the exclusive property of Trusty Owl and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Trusty Owl.
          </p>

          <h2 class="text-xl font-bold mb-4 text-[#2a4f4b]">3. Links To Other Web Sites</h2>
          <p class="mb-6">
            Our Service may contain links to third-party web sites or services that are not owned or controlled by Trusty Owl. Trusty Owl has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that Trusty Owl shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.
          </p>
